...
export class SpaceApiClient {
  ...
  ): Promise<CreateSpaceSuccessResponse> {
    try {
      const response = await this.axiosInstance.post<
        CreateSpaceSuccessResponse
      >(`${this.baseUrl}/createSpace`, data);
   ...
   */
  async getSpaceOwner(
    data: GetSpaceOwnerRequest,
  ): Promise<GetSpaceOwnerResponse[]> {
    try {
      const response = await this.axiosInstance.post<GetSpaceOwnerResponse[]>(
        `${this.baseUrl}/_getSpaceOwner`,
        data,
      );
      return response.data;
    } catch (error) {
   ...
   */
  async getSpaceName(
    data: GetSpaceNameRequest,
  ): Promise<GetSpaceNameResponse[]> {
    try {
      const response = await this.axiosInstance.post<GetSpaceNameResponse[]>(
        `${this.baseUrl}/_getSpaceName`,
        data,
      );
      return response.data;
    } catch (error) {
   ...
   */
  async getSpaceType(
    data: GetSpaceTypeRequest,
  ): Promise<GetSpaceTypeResponse[]> {
    try {
      const response = await this.axiosInstance.post<GetSpaceTypeResponse[]>(
        `${this.baseUrl}/_getSpaceType`,
        data,
      );
      return response.data;
    } catch (error) {
   ...
   */
  async getSpaceParent(
    data: GetSpaceParentRequest,
  ): Promise<GetSpaceParentResponse[]> {
    try {
      const response = await this.axiosInstance.post<GetSpaceParentResponse[]>(
        `${this.baseUrl}/_getSpaceParent`,
        data,
      );
      return response.data;
    } catch (error) {
   ...
   */
  async getSpaceChildren(
    data: GetSpaceChildrenRequest,
  ): Promise<GetSpaceChildrenResponse[]> {
    try {
      const response = await this.axiosInstance.post<
        GetSpaceChildrenResponse[]
      >(`${this.baseUrl}/_getSpaceChildren`, data);
      return response.data;
    } catch (error) {
      this.handleError(error);
    }
   ...
   */
  async getSpaceChildrenString(
    data: GetSpaceChildrenStringRequest,
  ): Promise<GetSpaceChildrenStringResponse[]> {
    try {
      const response = await this.axiosInstance.post<
        GetSpaceChildrenStringResponse[]
      >(`${this.baseUrl}/_getSpaceChildrenString`, data);
      return response.data;
    } catch (error) {
      this.handleError(error);
    }
  ...
  async getSpaces(): Promise<Space[]> {
    try {
      const response = await this.axiosInstance.post<Space[]>(
        `${this.baseUrl}/_getSpaces`,
        {},
      );
      return response.data;
    } catch (error) {
  ...
  async getSpacesString(): Promise<GetSpacesStringResponse[]> {
    try {
      const response = await this.axiosInstance.post<GetSpacesStringResponse[]>(
        `${this.baseUrl}/_getSpacesString`,
        {},
      );
      return response.data;
    } catch (error) {
